...
class SanskritProcessor:
    ...
    def __init__(self):
        ...
        if self.has_pyiwn:
            try:
                # Fix for the 'str' object has no attribute 'value' error
                # Use string parameter directly instead of assuming it's an enum
                self.iwn = pyiwn.IndoWordNet(lang="san")  # Use string directly
